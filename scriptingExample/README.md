...
### 已有脚本
快速访问：[钉钉消息推送](pushMessageDingtalk.js) | [Pushover 消息推送](pushMessagePushover.js) | [JWT Token 生成](jwt.js) | [文本信息提取](textExtract.js) | [URL 短链接生成](urlShortener.js) | [Base64 编码](base64Encode.js) | [Base64 解码](base64Decode.js) | [时间戳转换](timestampConverter.js) | [数据Mock生成器](mock.js) | [流式请求](commonAI.js) 等等...
...
### [按行去重文本并计数](deduplicateText.js)
按行去重文本，返回去重后的文本和出现次数
